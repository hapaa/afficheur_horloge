...
const static uint16_t mask[60]={  0b000000000100000,
                                  0b000010000010000,
                                  0b000101111110000,
                                  0b001000111110000,
                                  0b010011111110000,
...
const static uint16_t chiffres0b30] = {992, 544, 992,
                          0, 0, 992,
                            736, 672, 928,
                             992, 672, 672,
                              992, 128, 224,
...
void update_chiffre(uint16_t position_debut, uint16_t pos, uint16_t matrice0b])
{
  matrice0bposition_debut] = chiffres0b0+pos];
  matrice0bposition_debut+1] = chiffres0b1+pos];
  matrice0bposition_debut+2] = chiffres0b2+pos];
}
...
while(1){
    ...
    {
      char string0b64];
      itoa(chiffres0bsecondes_unite], string, 10);  //convert integer to string, radix=1
      uart_send(string);
    }
