...
uint16_t matrice[60] = {0b000000000100000,
                        0b000010000010000,
                        0b000101111110000,
                        0b001000111110000,
                        0b010011111110000,
...
/* Detection effet hall 
Update temps and pas */
void effet_hall(uint16_t *pas, uint16_t *temps)
{
  if (detection_hall >= 1)
  {
    detection_hall = 0;
...
int main(void)
{
  ...
  while (1)
  {
    ...
    if ((secondes + 1) * 1625 == compteur_secondes)
    {
      ...
      char string2[64];
      itoa(1, string2, 10); //convert integer to string, radix=1
      uart_send(string2s);

      char string[64];
      sprintf(string, "1"); //convert integer to string, radix=1
      uart_send(string);
    }
